...
import com.chen.hospital.util.BeanUtils;
import com.chen.hospital.util.HttpRequestHelper;
import com.chen.hospital.util.YyghException;
...
public class ApiServiceImpl implements ApiService {
    ...
    public JSONObject getHospital() {
        ...
        paramMap.put("sign", HttpRequestHelper.getSign(this.getSignKey()));
    ...
    public void  saveBatchHospital() throws IOException {
        ...
        for(int i=1, len=jsonArray.size(); i<len; i++) {
            ...
            paramMap.put("timestamp", HttpRequestHelper.getTimestamp());
            paramMap.put("sign", HttpRequestHelper.getSign(apiService.getSignKey()));
